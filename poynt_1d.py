...
#
# **************************************************
# warning: we assumed the folder starts at t=0
# so we can get delta_t from the TIME attribute 
# in the 2nd file in the sequence
# **************************************************
#
h5_filename = e2[1]  
...
for file_number in range(i_begin, i_end,skip):
    ...
    temp=(s1_data)
    # print(temp.shape)
    h5_output[file_number, 1:nx] = np.abs(np.convolve(temp[1:nx],avg_array,mode='same'))
